...
ALTER TABLE CLIENTE ADD CONSTRAINT CLIENTE_PK PRIMARY KEY (CPF_CNPJ);
...
ALTER TABLE PRODUTO ADD CONSTRAINT UNIDADE_MEDIDA_FK FOREIGN KEY (UNIDADE_MEDIDA) REFERENCES UNIDADE_MEDIDA(CODIGO);
...
ALTER TABLE VENDA_CABECALHO ADD CONSTRAINT CLIENTE_FK FOREIGN KEY(CLIENTE) REFERENCES CLIENTE(CPF_CNPJ);
...
ALTER TABLE VENDA_ITEM ADD CONSTRAINT VENDA_CABECALHO_FK FOREIGN KEY (CODIGO_VENDA, SERIE_VENDA) REFERENCES VENDA_CABECALHO(CODIGO,SERIE);